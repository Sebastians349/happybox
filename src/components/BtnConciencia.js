...
const BtnConciencia = props => {
  ...
  const mensaje = [
    ...
    '¿No te alcanza con ser más feliz, no?',
    ...
    'Se impuso como objetivo hacer un side-p por semana',
    'Tampoco esperemos un clon de MeLi...',
    'Pero de la nada. A un botón que te hace feliz.',
    '¡Es un montón!.',
    'La misma cantidad de papel picado en tu navegador.',
